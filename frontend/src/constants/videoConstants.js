...
export const PUBLIC_VIDEO_REQUEST = 'PUBLIC_VIDEO_REQUEST';
export const PUBLIC_VIDEO_SUCCESS = 'PUBLIC_VIDEO_SUCCESS';
export const PUBLIC_VIDEO_FAIL = 'PUBLIC_VIDEO_FAIL';
